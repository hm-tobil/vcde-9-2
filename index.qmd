...
Dies ermöglicht die Erkennung von Features über verschiedene Skalierungen — große Objekte auf groben Stufen, kleine Details auf feinen Stufen.

**8 Pyramidenstufen – ORB-SLAM (Skalierungsfaktor: 1.2):**

- Stufe 0: 640 × 480 (Original)
- Stufe 1: 533 × 400 (1.2× verkleinert)
- Stufe 3: 370 × 277 (1.73× verkleinert)
- Stufe 7: 179 × 134 (3.58× verkleinert)

**Rückprojektion zu echtem Bild:** $x_{original} = x_k \times 1.2^k$
...
**Features erkennen auf allen Stufen:**
- Große Features auf höheren Ebenen (gröber)
- Kleine Features auf unteren Ebenen (feiner)
- Quadtree-Verteilung sorgt für gleichmäßige Verteilung pro Stufe
:::
...
Features können ungleichmäßig verteilt sein (z.B. gehäuft an Kanten).
...
4. **Schritt 6:** Quadtree-Gleichverteilung
5. **Schritt 7:** Harris-Scoring für Robustheit
