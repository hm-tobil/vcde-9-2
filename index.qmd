...
<style>
  ...
  main h2 {
    ...
    background: linear-gradient(90deg, #deeaf7 0%, transparent 100%);
    border-radius: 0 8px 8px 0;
    margin: 2.2rem 0 .8rem 0;
  }
  /* Anchor link colour inside h2 */
  main h2 a.anchorjs-link { color: #2980b9 !important; }
  ...
  .vslam-slider {
    ...
    background: #ffffff;
    box-shadow: 0 6px 28px rgba(41, 128, 185, .10),
  ...
  .vslam-slider .vslam-btn {
    background: linear-gradient(135deg, #1a2e45 0%, #2980b9 100%);
    color: #fff; border: none;
    border-radius: 7px; padding: .38rem 1.05rem;
    cursor: pointer; font-size: .88rem; font-weight: 500;
    letter-spacing: .02em;
    transition: opacity .18s, transform .12s, box-shadow .18s;
    box-shadow: 0 2px 6px rgba(41,128,185,.3);
  }
  .vslam-slider .vslam-btn:not(:disabled):hover {
    opacity: .88;
    transform: translateY(-1px);
    box-shadow: 0 4px 10px rgba(41,128,185,.35);
  }
  .vslam-slider .vslam-btn:disabled {
    background: #c8d6e5;
    box-shadow: none;
    cursor: not-allowed;
  }
  ...
  /* Dots */
  .vslam-slider .vslam-dots { display: flex; gap: .45rem; align-items: center; }
  .vslam-slider .vslam-dot {
    width: 9px; height: 9px; border-radius: 50%;
    background: #c0d4e8; cursor: pointer;
    transition: background .2s, transform .2s;
  }
  .vslam-slider .vslam-dot.active {
    background: #2980b9;
    transform: scale(1.3);
  }
  .vslam-slider .vslam-counter {
    font-size: .82rem; color: #5a7ea0; font-weight: 500;
  }
</style>
