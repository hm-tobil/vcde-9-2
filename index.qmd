...
**Interaktive Visualisierung:** Bewegen Sie den Schieberegler, um die verschiedenen Pyramidenlevel zu sehen.

```{=html}
<div style="text-align: center; margin: 20px 0;">
  <iframe src="Andrijanic/bildpyramide_erklaerung.html" style="width: 100%; height: 600px; border: 2px solid #00ff00; border-radius: 5px;" title="Bildpyramide Interaktive Erklärung"></iframe>
</div>
```
...
```{=html}
<div style="text-align: center; margin: 20px 0;">
  <iframe src="Andrijanic/fast_detector_visualization.html" style="width: 100%; height: 600px; border: 2px solid #00ff00; border-radius: 5px;" title="FAST Detektor Visualisierung"></iframe>
</div>
```
...
```{=html}
<div style="text-align: center; margin: 20px 0;">
  <iframe src="Andrijanic/feature_example_visualization.html" style="width: 100%; height: 600px; border: 2px solid #00ff00; border-radius: 5px;" title="Feature Beispiel Visualisierung"></iframe>
</div>
```
...
::: {.vslam-slide}
#### Praktisches Beispiel: Feature auf echter Szene
Echte Beispiel aus dem Datensatz:

```{=html}
<div style="text-align: center; margin: 20px 0;">
  <iframe src="Andrijanic/pyramid_real_example.html" style="width: 100%; height: 600px; border: 2px solid #00ff00; border-radius: 5px;" title="Pyramid Real Beispiel"></iframe>
</div>
```

Diese Visualisierung zeigt, wie die Features tatsächlich in einer echten Szene erkannt werden.
:::
